...
// "Ask AI about me" launcher — floating pill that opens popular AI assistants
// pre-loaded with a prompt about Beetrus. Pure client, no deps, dismissible.
  ...
  return (
    <div
      style={{
        ...
        background: "rgba(14,13,16,0.86)", backdropFilter: "blur(14px)",
        border: "1px solid rgba(255,255,255,0.12)", borderRadius: 14,
        boxShadow: "0 18px 50px -18px rgba(0,0,0,0.7)", padding: "12px 14px",
        color: "#f4f1ea", fontFamily: "ui-monospace, 'JetBrains Mono', monospace",
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        >
          <span aria-hidden style={{ display: "grid", placeItems: "center", width: 22, height: 22, borderRadius: 6, background: "linear-gradient(135deg,#d9b23e,#7c5cff)", color: "#100f0d", fontWeight: 700, fontSize: 13 }}>✦</span>
          <span style={{ fontSize: 12.5, letterSpacing: ".02em" }}>
            Ask AI about <b style={{ color: "#d9b23e" }}>{SUBJECT}</b>
          </span>
          <span aria-hidden style={{ fontSize: 10, opacity: 0.6, transform: open ? "rotate(180deg)" : "none", transition: "transform .2s" }}>▾</span>
        </button>
